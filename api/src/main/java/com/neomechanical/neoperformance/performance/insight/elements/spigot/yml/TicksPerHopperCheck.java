...
public class TicksPerHopperCheck extends InsightElement {
    ...
    public boolean isInsightApplicableOrAlreadyPresent() {
        ...
        return yamlOthers.getConfig().getDouble("world-settings.default.ticks-per.hopper-check") > 24;
    }
    ...
    public String currentValue() {
        return yamlOthers.getConfig().getString("world-settings.default.ticks-per.hopper-check");
    }
