...
import com.neomechanical.neoperformance.performance.modules.smartNotifier.managers.LagDataManager;
import com.neomechanical.neoperformance.performance.modules.smartNotifier.report.LagReport;
import com.neomechanical.neoperformance.performance.modules.smartNotifier.report.LagReportBuilder;
...
public class LagChecker {
    ...
    public void start() {
        ...
        }.runTaskTimer(plugin, 0, 20L * plugin.getDataManager().lagNotifier().getLagNotifierRunInterval());
    }
}
